...
public class Questions {
    ...
    public Questions(BigInteger questionId, ArrayList<String> questionOptions, String questionTitle, Integer questionAnswer, BigDecimal questionMarks, Integer chosenAnswer, BigDecimal marksScored) {
